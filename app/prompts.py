...
def build_system_prompt(member_name: str, member_role: str, family_roster: str,
    ...
    voice_hint = (
        ...
        "To sound like you're thinking or hesitating, use a dash — or a longer pause like this "
        "-- -- — or an ellipsis... right where you'd naturally trail off; with this voice ElevenLabs "
        "turns those into a natural \"uhh\"-style pause. CRITICAL: do NOT spell hesitation out as a "
        "sound/word (NOT \"أمم\"، NOT \"آاه\"، NOT \"اممم\") — the TTS reads those literally as a word "
